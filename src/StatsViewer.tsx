...
const StatsViewer: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    useEffect(() => {
        ...
        const initStats = async () => {
            try {
                // 1. Obtener Logos de Equipos (Una sola vez al montar)
                ...
                // 2. Escuchar Stats en Tiempo Real
                ...
                unsubscribe = onSnapshot(q, (snapshot) => {
                    ...
                    snapshot.docs.forEach(doc => {
                        ...
                        // Contar partidos (cada documento es un partido jugado por ese jugador)
                    ...
                    const processedPlayers: PlayerStat[] = Object.values(aggregated).map((p: any) => {
                        ...
                        // Valoración Ajustada (Sin asistencias): (PTS + REB) - FALTAS
                ...
                console.error("Error iniciando stats:", error);
                setLoading(false);
            }
        };
                ...
                {data.map((p: PlayerStat, i: number) => {
                    ...
                    return (
                        <div key={p.id} style={{
                            ...
                            background: isTop1 ? '#fdf8e8' : 'transparent',
                            ...
                            <div style={{textAlign:'right'}}>
                                <div style={{fontWeight:'900', fontSize: isTop1 ? '1.3rem' : '1rem', color: color}}>
                                    {/* CORRECCIÓN AQUÍ: Detectar 'Anotadores' correctamente */}
                                    {title.includes('MVP') ? p.valpg : 
                                     title.includes('Anotadores') ? p.ppg : 
                                     title.includes('Rebotes') ? p.rpg : p.tpg}
                                </div>
                ...
                <div style={{
                    ...
                    <div style={{display:'flex', alignItems:'center', gap:'15px'}}>
                        ...
                        <div>
                            ...
                            <span style={{opacity:0.8, fontSize:'0.85rem'}}>Estadísticas en Tiempo Real</span>
                        </div>
                    </div>
                ...
                <div style={{flex:1, overflowY:'auto', padding:'25px'}}>
                    {loading ? (
                        ...
                        <div style={{
                            ...
                            {/* FILA INFERIOR: PUNTOS, REBOTES, TRIPLES */}
